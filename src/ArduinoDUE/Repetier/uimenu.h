...
UI_MENU_ACTIONCOMMAND(ui_menu_setlang_jp, "ÆÎÝºÞ", UI_ACTION_LANGUAGE_JP | UI_ACTION_TOPMENU)
#if FIRSTLANG
...
#define UI_MENU_LANGUAGES {UI_MENU_ADDCONDBACK ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR ADD_LANG_JP}
#define UI_MENU_LANGUAGES_WIZ {ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR ADD_LANG_JP}
UI_MENU(ui_menu_languages, UI_MENU_LANGUAGES, UI_MENU_BACKCNT + LANGUAGE_EN_ACTIVE + LANGUAGE_DE_ACTIVE + LANGUAGE_ES_ACTIVE + LANGUAGE_PT_ACTIVE + LANGUAGE_FR_ACTIVE + LANGUAGE_NL_ACTIVE + LANGUAGE_IT_ACTIVE + LANGUAGE_FI_ACTIVE + LANGUAGE_SE_ACTIVE + LANGUAGE_CZ_ACTIVE + LANGUAGE_PL_ACTIVE + LANGUAGE_TR_ACTIVE + LANGUAGE_JP_ACTIVE)
...
#endif // LANGUAGE_TR_ACTIVE
#if LANGUAGE_JP_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_jp,"ÆÎÝºÞ        %Lc",UI_ACTION_LANGUAGE_JP, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_JP &ui_menu_setlang_jp
#undef FIRSTLANG
#define FIRSTLANG 0
...
//page4
UI_MENU_ACTION4_T(ui_menu_manual_level_page4,UI_ACTION_DUMMY,UI_TEXT_MANUAL_BED_LEVEL_PAGE_4A_ID,UI_TEXT_MANUAL_BED_LEVEL_PAGE_4B_ID,UI_TEXT_MANUAL_BED_LEVEL_PAGE_4C_ID,UI_TEXT_MANUAL_BED_LEVEL_PAGE_4D_ID, ALL_MODE)
//page5
