...
#define FIRSTLANG 1
#if LANGUAGE_EN_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_en,"English",UI_ACTION_LANGUAGE_EN | UI_ACTION_TOPMENU, ADVANCED_MODE)
#define ADD_LANG_EN &ui_menu_setlang_en
#undef FIRSTLANG
#define FIRSTLANG 0
#else
...
#endif // LANGUAGE_EN_ACTIVE
#if LANGUAGE_DE_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_de,"Deutsch",UI_ACTION_LANGUAGE_DE | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_DE &ui_menu_setlang_de
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_DE_ACTIVE
#if LANGUAGE_ES_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_es,"Espanol",UI_ACTION_LANGUAGE_ES | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_ES &ui_menu_setlang_es
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_ES_ACTIVE
#if LANGUAGE_PT_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_pt,"Portugues",UI_ACTION_LANGUAGE_PT | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_PT &ui_menu_setlang_pt
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_PT_ACTIVE
#if LANGUAGE_FR_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_fr,"Francais",UI_ACTION_LANGUAGE_FR | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_FR &ui_menu_setlang_fr
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_FR_ACTIVE
#if LANGUAGE_NL_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_nl,"Nederlandse",UI_ACTION_LANGUAGE_NL | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_NL &ui_menu_setlang_nl
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_NL_ACTIVE
#if LANGUAGE_IT_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_it,"Italiano",UI_ACTION_LANGUAGE_IT | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_IT &ui_menu_setlang_it
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_IT_ACTIVE
#if LANGUAGE_SE_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_se,"Svenska",UI_ACTION_LANGUAGE_SE | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_SE &ui_menu_setlang_se
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_SE_ACTIVE
#if LANGUAGE_CZ_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_cz,"Cestina",UI_ACTION_LANGUAGE_CZ | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_CZ &ui_menu_setlang_cz
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_CZ_ACTIVE
#if LANGUAGE_PL_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_pl,"Polski",UI_ACTION_LANGUAGE_PL | UI_ACTION_TOPMENU, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_PL &ui_menu_setlang_pl
#undef FIRSTLANG
#define FIRSTLANG 0
...
UI_MENU(ui_menu_settings,UI_MENU_SETTINGS,10+LANGMENU_COUNT+UI_TOGGLE_LIGHT_COUNT+UI_TOGGLE_BADGE_LIGHT_COUNT+UI_SOUND_COUNT+UI_SENSOR_ONOFF_COUNT+UI_TOP_SENSOR_ONOFF_COUNT+UI_WIFI_ONOFF_COUNT+UI_POWER_SAVE_COUNT+MENU_PSON_COUNT+UI_MENU_EEPROM_CNT+UI_MENU_BEDCONF_CNT+UI_MENU_DELTA_CNT+UI_MENU_SL_CNT+UI_MENU_BACKCNT);//BUG without this ; compilation crash
