...
#endif // LANGUAGE_PL_ACTIVE
#if LANGUAGE_FI_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_fi,"Suomi       %La",UI_ACTION_LANGUAGE_FI, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_FI &ui_menu_setlang_fi
#undef FIRSTLANG
#define FIRSTLANG 0
...
#endif // LANGUAGE_FI_ACTIVE
#if LANGUAGE_TR_ACTIVE
    UI_MENU_ACTIONCOMMAND(ui_menu_setlang_tr,"Turkce       %Lb",UI_ACTION_LANGUAGE_TR, ADVANCED_MODE)
#if FIRSTLANG
#define ADD_LANG_TR &ui_menu_setlang_tr
#undef FIRSTLANG
#define FIRSTLANG 0
