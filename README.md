...
Build Status: [![Build Status](https://travis-ci.org/luc-github/Repetier-Firmware-0.92.svg?branch=testing)](https://travis-ci.org/luc-github/Repetier-Firmware-0.92)    
